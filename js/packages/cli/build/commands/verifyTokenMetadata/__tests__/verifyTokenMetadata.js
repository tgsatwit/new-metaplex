...
describe('`metaplex verify_token_metadata`', function () {
    ...
    it('throws on invalid share allocation', function () {
        expect(function () {
            return index_1.verifyAggregateShare([{ address: 'some-solana-address', share: 80 }], 'placeholder-manifest-file');
    ...
    it('warns when there are inconsistent share allocations', function () {
        ...
        index_1.verifyCreatorCollation([{ address: 'some-solana-address', share: 80 }], collatedCreators, '0.json');
        expect(spy).toHaveBeenCalledTimes(1);
    });
